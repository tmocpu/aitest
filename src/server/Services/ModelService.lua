...
local CHARACTER_SPECS = {
	{
		...
		HeadSize = Vector3.new(2.2, 2.0, 2.2),
		BodySize = Vector3.new(3.0, 2.4, 2.8),
		ArmSize = Vector3.new(0.8, 2.0, 0.8),
		LegSize = Vector3.new(0.9, 1.4, 0.9),
		HeadOffset = Vector3.new(0, 3.4, 0),
		ArmOffsetL = Vector3.new(-2.0, 1.6, 0),
		ArmOffsetR = Vector3.new(2.0, 1.6, 0),
		LegOffsetL = Vector3.new(-0.8, -0.5, 0),
		LegOffsetR = Vector3.new(0.8, -0.5, 0),
		HeadShape = "Sphere",
	...
	},
	{
		...
		HeadSize = Vector3.new(3.0, 2.6, 2.8),
		BodySize = Vector3.new(5.0, 3.6, 3.4),
		ArmSize = Vector3.new(1.2, 2.6, 1.2),
		LegSize = Vector3.new(1.1, 1.0, 1.1),
		HeadOffset = Vector3.new(0, 4.8, 0),
		ArmOffsetL = Vector3.new(-3.2, 2.0, 0),
		ArmOffsetR = Vector3.new(3.2, 2.0, 0),
	...
	},
	{
		...
		BodySize = Vector3.new(3.8, 2.2, 3.4),
		ArmSize = Vector3.new(0.8, 1.6, 0.8),
		LegSize = Vector3.new(0.9, 1.2, 0.9),
		HeadOffset = Vector3.new(0, 3.2, 0),
		ArmOffsetL = Vector3.new(-2.4, 1.4, 0),
		ArmOffsetR = Vector3.new(2.4, 1.4, 0),
		LegOffsetL = Vector3.new(-1.0, -0.4, 0),
		LegOffsetR = Vector3.new(1.0, -0.4, 0),
		HeadShape = "Sphere",
		UniqueFeature = "Shell",
	},
	{
		...
		HeadSize = Vector3.new(3.4, 2.0, 2.6),
		BodySize = Vector3.new(4.2, 3.0, 3.0),
		ArmSize = Vector3.new(1.0, 2.0, 1.0),
		LegSize = Vector3.new(1.0, 1.4, 1.0),
		HeadOffset = Vector3.new(0, 4.0, 0),
		ArmOffsetL = Vector3.new(-2.8, 1.8, 0),
		ArmOffsetR = Vector3.new(2.8, 1.8, 0),
		LegOffsetL = Vector3.new(-1.2, -0.4, 0),
		LegOffsetR = Vector3.new(1.2, -0.4, 0),
		HeadShape = "Block",
	...
	},
	{
		...
		BodySize = Vector3.new(2.2, 2.6, 2.0),
		ArmSize = Vector3.new(0.6, 2.4, 0.6),
		LegSize = Vector3.new(0.5, 3.2, 0.5),
		HeadOffset = Vector3.new(0, 4.8, 0),
		ArmOffsetL = Vector3.new(-1.6, 2.0, 0),
		ArmOffsetR = Vector3.new(1.6, 2.0, 0),
	...
	},
	{
		...
		HeadSize = Vector3.new(2.8, 2.6, 2.6),
		BodySize = Vector3.new(4.4, 3.4, 3.0),
		ArmSize = Vector3.new(1.0, 2.6, 1.0),
		LegSize = Vector3.new(1.1, 1.8, 1.1),
		HeadOffset = Vector3.new(0, 4.6, 0),
		ArmOffsetL = Vector3.new(-2.8, 2.0, 0),
		ArmOffsetR = Vector3.new(2.8, 2.0, 0),
		LegOffsetL = Vector3.new(-1.2, -0.6, 0),
		LegOffsetR = Vector3.new(1.2, -0.6, 0),
		HeadShape = "Sphere",
		UniqueFeature = "Horn",
	},
	{
		...
		HeadSize = Vector3.new(2.0, 1.4, 1.8),
		BodySize = Vector3.new(3.6, 1.6, 2.4),
		ArmSize = Vector3.new(0.7, 1.4, 0.7),
		LegSize = Vector3.new(0.8, 1.0, 0.8),
		HeadOffset = Vector3.new(0, 2.4, 0),
		ArmOffsetL = Vector3.new(-2.4, 1.0, 0),
		ArmOffsetR = Vector3.new(2.4, 1.0, 0),
		LegOffsetL = Vector3.new(-1.4, 0.0, 0),
		LegOffsetR = Vector3.new(1.4, 0.0, 0),
		HeadShape = "Block",
		UniqueFeature = "Spots",
	},
	{
		...
		BodySize = Vector3.new(2.8, 4.0, 2.8),
		ArmSize = Vector3.new(0.7, 2.2, 0.7),
		LegSize = Vector3.new(0.8, 1.4, 0.8),
		HeadOffset = Vector3.new(0, 4.6, 0),
		ArmOffsetL = Vector3.new(-2.0, 2.2, 0),
		ArmOffsetR = Vector3.new(2.0, 2.2, 0),
		LegOffsetL = Vector3.new(-0.8, -0.4, 0),
		LegOffsetR = Vector3.new(0.8, -0.4, 0),
		HeadShape = "Cylinder",
